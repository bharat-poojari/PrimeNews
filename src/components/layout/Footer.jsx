    ...
    <footer className="bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 mt-auto">
      <div className="container mx-auto px-4 py-8 lg:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          ...
          <div className="text-center sm:text-left">
            ...
            <div className="flex justify-center sm:justify-start space-x-2">
              <a
                ...
                className="p-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md text-gray-600 dark:text-gray-400 hover:text-blue-600 hover:border-blue-600 transition-all"
                aria-label="Twitter"
              >
          ...
          {/* Categories */}
          <div className="text-center sm:text-left">
            <h3 className="font-serif text-lg font-bold text-gray-900 dark:text-white mb-3">Categories</h3>
          ...
          {/* Quick Links */}
          <div className="text-center sm:text-left">
            <h3 className="font-serif text-lg font-bold text-gray-900 dark:text-white mb-3">Quick Links</h3>
            <ul className="space-y-1.5">
              {quickLinks.map((link) => (
                <li key={link.path}>
                  <Link
          ...
          {/* Contact Info */}
          <div className="text-center sm:text-left">
            <h3 className="font-serif text-lg font-bold text-gray-900 dark:text-white mb-3">Contact</h3>
            ...
            {/* Newsletter */}
            <div className="mt-4">
              <h4 className="font-semibold text-gray-900 dark:text-white text-sm mb-2">Newsletter</h4>
              <form onSubmit={handleSubscribe} className="flex flex-col gap-2">
                <input
                  type="email"
                  name="email"
                  placeholder="Your email"
                  className="px-3 py-2 text-sm bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:border-blue-600 transition-colors"
                  required
                />
                <button
                  type="submit"
        ...
        <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
          <div className="flex flex-col sm:flex-row items-center justify-between text-xs text-gray-500 dark:text-gray-400 gap-2">
